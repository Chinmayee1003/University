...
<body>
	...
	<div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid rounded mb-4 mb-lg-0" src="img/Department-Electrical-Electronics-Communication-Engineering.jpg" alt="">
                </div>
		<div class="col-lg-7">
                    ...
                    <p>
A 4-year B.Tech. Electronics and Communication Engineering programme seeks to produce skilled electronics and communication professionals with a strong foundation in the fundamentals of Electronics and Communication Engineering who can engineer large, relevant, and robust electronics & communication systems.

The curriculum is designed to deliver comprehensive knowledge and teachings on electronics and communication engineering to ensure students develop a complete understanding of the subject. A degree in this programme will cover the following topics:</p>
					<ul class="list-inline text-BLACK m-0">
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Analog & Digital Communication</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Digital Logic & Circuits</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Coding & Information Theory</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Wireless Networking</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Signal Processing</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Electronics Architecture & Protocols</li>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid rounded mb-4 mb-lg-0" src="img/phd-parttime-gitam.jpg" alt="">
                </div>
		<div class="col-lg-7">
                    <div class="text-left mb-4">
                        
                        <h3>Career Options for B.Tech ECE
</h3>
                    <p>Students who enroll in the B.Tech. Electronics and Communication Engineering programme will develop the necessary skills to become successful professionals and experts in the field. The wide range of career opportunities include:

</p>


					<ul class="list-inline text-BLACK m-0">
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Telecom Engineer</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>R&D Software Engineer</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Software Analyst</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Electronic Design Engineer
</li>
						
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Desktop Support Engineer</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Technical Director
</li>
                        
						
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Network Planning Engineer</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Service Engineer</li>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid rounded mb-4 mb-lg-0" src="img/electrical.jpg" alt="">
                </div>
		<div class="col-lg-7">
                    <div class="text-left mb-4">
                        
                        <h3>Scope of B.Tech ECE</h3>
                    <p>Upon the completion of the programme, students will be able to design and develop electronic, communication, and signal processing systems for engineering applications in the fields of consumer electronics, embedded, wireless communication, networking, and allied interdisciplinary areas. Graduates will also learn how to research and devise appropriate technologies for the implementation of the electronics and telecommunication systems as an entrepreneur/researchers with professional ethics & concern for societal wellbeing.
