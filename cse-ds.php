...
<body>
	...
	<div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid rounded mb-4 mb-lg-0" src="img/data-science-gitam.jpg" alt="">
                </div>
		<div class="col-lg-7">
                    ...
                    <p>Our 4-year B.Tech. Computer Science and Engineering (Data Science) programme seeks to develop skilled professionals with expertise in computer, data science, and business skills to serve the growing digital world.

A B.Tech. Computer Science and Engineering (Data Science) from our institute will provide students with the right engineering knowledge, design & development of solutions, problem analysis, sustainability, project management, and effective business communication. A degree in this programme will cover the following topics:</p>
					<ul class="list-inline text-BLACK m-0">
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Basic engineering mechanics & physics</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Mathematical reasoning and statistics</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Data structures and algorithm design</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Machine Learning & Virtualization</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Natural Language Processing & Neural Networks</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Big Data Analytics & Deep Learning</li>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid rounded mb-4 mb-lg-0" src="img/computerscience-gitam.jpg" alt="">
                </div>
		<div class="col-lg-7">
                    <div class="text-left mb-4">
                        
                        <h3>Career Options for B.Tech.CSE (DS)</h3>
                    <p>Students who enroll in the B.Tech. Computer Science and Engineering (Data Science) programme will open a world of opportunities for themselves in this world driven by data-based innovations. Career options include:</p>


					<ul class="list-inline text-BLACK m-0">
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Data Scientist</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Data Analyst</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Business Analyst</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Data Engineer</li>
						
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Product Manager</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Lead Data Scientist</li>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid rounded mb-4 mb-lg-0" src="img/computerscience.jpg" alt="">
                </div>
		<div class="col-lg-7">
                    <div class="text-left mb-4">
                        
                        <h3>Scope of B.Tech.CSE (DS)</h3>
                    <p>The programme will enable students to demonstrate proficiency in Data Science, leading to successful careers as Data Scientists. The graduates will exhibit commitment to developing sustainable data-based solutions that satisfy the modern data analysis and scientific application needs. The graduates will adapt to and aid in technological advances by life-long learning and innovation.</p>
