...
<body>
                    ...
                    <div class="navbar-nav w-100">
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0">
                                ...
                                <a href="cse-aiml" class="dropdown-item">CSE-AIML</a>
	...
	<div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid rounded mb-4 mb-lg-0" src="img/lb_rules-5.jpg" alt="">
                </div>
		<div class="col-lg-7">
                    <div class="text-left mb-4">
                        
                        <h3>B.Tech.CSE (Cyber-Sec)</h3>
                        
                    <p>Our 4-year B.Tech Computer Science and Engineering (Cyber Security) programme seeks to produce competent Cyber Security professionals who have the right theoretical and practical knowledge to secure software and hardware systems.

A B.Tech Computer Science and Engineering (Cyber Security) will enable students to become professionals who can secure the technical world from all kinds of threats. Through this programme, students will acquire theoretical and practical knowledge and insights into cybersecurity. A degree in this program will cover the following topics.</p>
					<ul class="list-inline text-BLACK m-0">
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Cyber Crime & Network Security</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Data Structure</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Design and Analysis of Algorithms</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Cryptography</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Intrusion Detection and Prevention</li>
                    </ul>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid rounded mb-4 mb-lg-0" src="img/Undergraduate-Programmes-gitam-m.jpg" alt="">
                </div>
		<div class="col-lg-7">
                    <div class="text-left mb-4">
                        
                        <h3>Career Options for B.Tech.CSE (Cyber-Sec)</h3>
                    <p>Students who enroll in the B.Tech Computer Science and Engineering (Cyber Security) programme will become a part of the emerging cybersecurity workforce. Career options include:


					<ul class="list-inline text-BLACK m-0">
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Cyber Security Manager</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Security Specialist</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Security Analyst and Engineer
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Security Architect</li>
						
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Forensic Expert
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Penetration Tester</li>
						</li>
						</li>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid rounded mb-4 mb-lg-0" src="img/computer_science_1.jpg" alt="">
                </div>
		<div class="col-lg-7">
                    <div class="text-left mb-4">
                        
                        <h3>Scope of B.Tech.CSE (Cyber-Sec)</h3>
                    <p>The programme will educate them on how to design and develop cybersecurity applications of varying complexities in emerging areas of technology, engineering, and innovation.</p>
