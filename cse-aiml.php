...
<body>
	...
	<div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid rounded mb-4 mb-lg-0" src="img/Undergraduate-gitam.jpg" alt="">
                </div>
		<div class="col-lg-7">
                    ...
                    <p>Our 4-year B.Tech Computer Science and Engineering (AI-ML) programme seeks to produce competent engineers in the field of Artificial Intelligence who can contribute to the field by developing data analytics, scientific computation, numerical & statistical analysis, and other Machine Learning capabilities.

B.Tech Computer Science and Engineering (AI-ML) helps students to design and develop computer-based applications of varying complexities in emerging areas of AI & ML. The curriculum primarily focuses on the foundations of computational mathematics, core components of Computer Science, along with the latest advancements in Artificial Intelligence and Machine Learning. A degree in this program will cover the following topics:</p>
					<ul class="list-inline text-BLACK m-0">
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Artificial Intelligence, Machine Learning, and Data Science</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Neural Networks and Natural Language Processing</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Algorithms and Pattern Recognition</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Robotics, Automata, and Deep Learning</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Sensors, Computer Vision, and Big Data</li>
                    </ul>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid rounded mb-4 mb-lg-0" src="img/3-academics_2.jpg" alt="">
                </div>
		<div class="col-lg-7">
                    <div class="text-left mb-4">
                        
                        <h3>Career Options for B.Tech.CSE (AI-ML)</h3>
                    <p>Students who enroll in the B.Tech. Computer Science and Engineering (AI-ML) programme will assist graduates in developing a comprehensive understanding of the field, preparing them for a wide range of opportunities. Career options include:</p>




					<ul class="list-inline text-BLACK m-0">
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Software Engineer</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Software Tester</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Application Developer</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Information and Multimedia Designer</li>
						
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Medical Information Scientist</li>

                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Technology Developer</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>IT Specialist</li>
				
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Technical Consultant</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Quality Analyst</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Information Network Manager</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Data Quality Analyst</li>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid rounded mb-4 mb-lg-0" src="img/phd-gitam.jpg" alt="">
                </div>
		<div class="col-lg-7">
                    <div class="text-left mb-4">
                        
                        <h3>Scope of B.Tech.CSE (AI-ML)</h3>
                    <p>The programme will enable students to design and develop computer-based applications of varying complexities in emerging areas of Artificial Intelligence and Machine Learning. Upon completion of the programme, graduates will apply the knowledge of algorithms, analytics, and data to solve real-world problems. The programme will also enable graduates to leverage their skills and develop a successful career by working with the latest technological advancements.</p>
