...
<body>
	...
	<div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid rounded mb-4 mb-lg-0" src="img/Mechanical-Engineering-1.jpg" alt="">
                </div>
		<div class="col-lg-7">
                    ...
                    <p>A 4-year B.Tech Mechanical Engineering programme seeks to produce competent mechanical engineers who can apply the principles of mechanical engineering for designing, manufacturing, and maintenance of mechanical systems. The programme will provide tremendous opportunities to mechanical professionals in the technology-driven world to create innovative solutions.

Our B.Tech Mechanical Engineering programme prepares the students to deal with the design, construction, and use of machines. The programme has a diverse curriculum that equips students with the necessary skills to become professionals in the field. A degree in this programme will cover the following topics:</p>
					<ul class="list-inline text-BLACK m-0">
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Smart manufacturing</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Design engineering</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Thermal engineering</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Electric & hybrid vehicles</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>AI & ML</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Industrial engineering</li>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid rounded mb-4 mb-lg-0" src="img/Mtech-machine-design-gitam.jpg" alt="">
                </div>
		<div class="col-lg-7">
                    <div class="text-left mb-4">
                        
                        <h3>Career Options for B.Tech Mech. Engineering
</h3>
                    <p>Students who enroll in the B.Tech Mechanical Engineering programme thrive as professional engineers in core mechanical engineering and other allied fields. The wide range of career opportunities include:</p>


					<ul class="list-inline text-BLACK m-0">
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Automobile Engineer</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Industrial Engineer</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Thermal Engineer</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Product Designers</li>
						
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Manufacturing Engineer</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Material Technologist</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Engineering Designer</li>
						
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Computer-Aided Designer</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Energy Engineer</li>
						
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Mechatronics Engineer</li>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid rounded mb-4 mb-lg-0" src="img/mechanical_eng-gitam-campus.jpg" alt="">
                </div>
		<div class="col-lg-7">
                    <div class="text-left mb-4">
                        
                        <h3>Scope of B.Tech Mech. Engineering</h3>
                    <p>Upon the completion of the programme, students will show competency in diagnosing, interpreting, and unraveling engineering problems in the fields of mechanical design, thermal engineering. Graduates will also develop the ability to create state-of-the-art technologies in futuristic areas of mechanical engineering through ground-breaking research.</p>
